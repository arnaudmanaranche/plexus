...
function renderHtml(graph, directDeps, rootPkg, resolutions = {}, bundleSizes = {}, meta = {}) {
  ...
  toolbarRows.push(
    '<button type="button" class="filter-btn" data-filter="direct">Direct only</button>',
    '<button type="button" class="filter-btn" data-filter="ok">No issues</button>',
  ...
  (function () {
    ...
    if (sortBtn) {
      sortBtn.addEventListener('click', function () {
        ...
        /* Fragment: one replaceChildren arg (avoids apply() arg limits) and drops stray text nodes between cards */
